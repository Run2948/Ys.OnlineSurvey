...
{
    public class QuickUserPermissionAttribute : AuthorizeAttribute
    {
    ...
    public class QuickAdminPermissionAttribute : AuthorizeAttribute
    {
        protected string ControllerName = string.Empty;
        ...
        {
            return HttpContext.Current.Session.Get<UserInfoOutputDto>(QuickKeys.ADMIN_SESSION) != null;
        }

        protected UserInfoOutputDto GetAdminSession()
        {
            return HttpContext.Current.Session.Get<UserInfoOutputDto>(QuickKeys.ADMIN_SESSION);
        }
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (!IsAdminLogin())
            {
                filterContext.Result = new ContentResult() { Content = QuickKeys.ADMIN_LOGIN };
                return;
            }
