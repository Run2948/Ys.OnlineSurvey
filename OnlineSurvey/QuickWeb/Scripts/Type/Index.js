...
function loadTables(startPage, pageSize) {
	...
	$.ajax({
		type: "GET",
		url: "/Admin/Type/GetSystemTypes?pageIndex=" + startPage + "&pageSize=" + pageSize + "&_t=" + new Date().getTime(),
...
function edit(id) {
	$.ajax({
		type: "Get",
		url: "/Admin/Type/Get?id=" + id + "&_t=" + new Date().getTime(),
...
//保存
function save() {
	var postData = { "dto": { "Id": $("#Id").val(), "TypeName": $("#TypeName").val(), "Name": $("#Name").val() } };
	$.ajax({
		type: "Post",
		url: "/Admin/Type/Edit",
		data: postData,
