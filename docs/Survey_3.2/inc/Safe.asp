...
function test(values,re)
  ...
  if regex.test(values) then
    ...
    Response.Write("<div style='position:fixed;top:0px;width:100%;height:100%;background-color:white;color:green;font-weight:bold;border-bottom:5px solid #999;'><br>您的提交带有不合法参数,感谢您对程序的检测!<br><br>了解更多请点击:<a href='http://www.xiao5u.com'>校无忧科技</a></div>")
    Response.end
   end if
   set regex = nothing
end function 
